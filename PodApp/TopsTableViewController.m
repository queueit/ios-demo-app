...
- (void)viewDidLoad {
    ...
    NSString* desc = @"For very yummi cup cakes";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = [[self.products objectAtIndex:indexPath.row]title];
    cell.imageView.image = [UIImage imageNamed:[[self.products objectAtIndex:indexPath.row]previewImage]];
